...
export default function SignUp({ params, searchParams }) {
	return (
		<Suspense>
			<AuthSession>
		...
		<article className="px-16 py-12">
			<header className="mb-8">
				<h1 className="text-3xl mb-4 font-extrabold font-display text-amber-500">
					<span className="block text-sm">Welcome to your </span>Dream
					Music Player
				</h1>
