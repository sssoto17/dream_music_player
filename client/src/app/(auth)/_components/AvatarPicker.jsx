...
export default function AvatarPicker({ name, value, submit, children }) {
  return (
    <label
      htmlFor={name}
    ...
    >
      <AvatarPickerIcon hasPreview={value && URL.createObjectURL(value)} />
      {value ? <span className="z-10 cursor-pointer">Remove</span> : children}
      <input
        name={name}
        type="file"
        accept="image/*"
